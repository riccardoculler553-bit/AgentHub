...
> **V1.6 范围（Fleet Execution & Operationalization）**：[docs/v1.6-product-roadmap.md](docs/v1.6-product-roadmap.md)（多设备执行与运行管理。SaaS、计费、MSP、Job 扇出不在该版本内）。本文档仍是 V1.5 实现快照；P0 落地见其后的 Fleet-1.0。
